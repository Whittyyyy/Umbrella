...
Furion.optionLinkenDiffusal = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Diffusal", false)
Furion.optionLinkenForce = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Force Staff", false)
Furion.optionLinkenPike = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Hurricane Pike", false)
Furion.optionLinkenMedallion = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Medallion of Courage", false)
Furion.optionLinkenNullifier = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Nullifier", false)
Furion.optionLinkenRod = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Rod", false)
Furion.optionLinkenSolar = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Solar Crest", false)
Furion.optionLinkenUrn = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Urn of Shadows", false)
Furion.optionLinkenVessel = Menu.AddOptionBook({"Hero Specific", "Nature's Prophet", "Linken"}, "Spirit Vessel", false)
